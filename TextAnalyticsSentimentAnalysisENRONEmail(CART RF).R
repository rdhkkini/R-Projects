...
enronJustSentiment
names(enronLabledTerms)
nrow(enronLabledTerms)
ncol(enronJustSentiment)
...
table(enronLabledTerms$Sentiment)
enronPositiveTerms <- subset(enronLabledTerms, enronLabledTerms$Sentiment == "Positive")
enronNegativeTerms <- subset(enronLabledTerms, enronLabledTerms$Sentiment == "Negative")
enronNeutralTerms <- subset(enronLabledTerms, enronLabledTerms$Sentiment == "Neutral")

qplot(enronPositiveTerms)
#========================================
# SPLIT data
#========================================
...
splitVector <- sample.split(enronLabledTerms$responsive, SplitRatio = 0.7) # caTools package (randomly splits)
